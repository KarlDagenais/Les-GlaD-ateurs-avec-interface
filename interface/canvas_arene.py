...
class CanvasArene(Canvas):
    ...
    def dessiner_de(self, coordonnees, gauche, haut, droite, bas):
        ...
        if texte_de.isnumeric() or texte_de == 'X':
            ...
            l = (droite-gauche)/10
            d = ((droite-gauche)-(4*l))/3
            if texte_de == '⚁':
                self.create_oval(gauche + l, haut + l, gauche + l + d, haut + l + d, fill='black') #haut gauche
                self.create_oval(gauche + 2*d + 3*l, haut + 2*d +3*l, droite - l, bas - l, fill='black') #bas droite
            if texte_de == '⚂':
                self.create_oval(gauche + l, haut + l, gauche + l + d, haut + l + d, fill='black') #haut gauche
                self.create_oval(gauche + 2*d + 3*l, haut + 2*d +3*l, droite - l, bas - l, fill='black') #bas droite
                self.create_oval(gauche + 2*l +d, haut + 2*l+d, gauche + 2*l + 2*d, haut + 2*l + 2*d, fill='black') #centre
            if texte_de == '⚃':
                self.create_oval(gauche + l, haut + l, gauche + l + d, haut + l + d, fill='black') #haut gauche
                self.create_oval(gauche + 2*d + 3*l, haut + 2*d +3*l, droite - l, bas - l, fill='black') #bas droite
                self.create_oval(gauche + 2*d +3*l, haut + l, gauche + 3*l + 3*d, haut + l + d, fill='black') #haut droite
                self.create_oval(gauche + l, haut + 2 * d + 3*l, gauche+d+l, bas - l, fill='black')  # bas gauche
            if texte_de == '⚄':
                self.create_oval(gauche + l, haut + l, gauche + l + d, haut + l + d, fill='black') #haut gauche
                self.create_oval(gauche + 2*d + 3*l, haut + 2*d +3*l, droite - l, bas - l, fill='black') #bas droite
                self.create_oval(gauche + 2*d +3*l, haut + l, gauche + 3*l + 3*d, haut + l + d, fill='black') #haut droite
            ...
            if texte_de == '⚅':
                ...
                self.create_oval(gauche + 2*d +3*l, haut + l, gauche + 3*l + 3*d, haut + l + d, fill='black') #haut droite
                self.create_oval(gauche + l, haut + 2 * d + 3*l, gauche+d+l, bas - l, fill='black')  # bas gauche
                self.create_oval(gauche + l, haut + d+ 2*l, gauche + l + d, haut + 2*l + 2*d, fill='black')  # milieu gauche
                self.create_oval(gauche + 2 * d + 3 * l, haut + d + 2*l, gauche + 3 * l + 3 * d, haut + 2*l + 2*d,
                             fill='black')  # milieu droite
